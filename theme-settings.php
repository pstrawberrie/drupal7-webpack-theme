 ...
 */
function drupal7webpack_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['drupal7webpack_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('drupal7webpack sample setting'),
  '#default_value' => theme_get_setting('drupal7webpack_example'),
